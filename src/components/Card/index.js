...
const Card = ({ title, price, img }) => {
    ...
    }, [isAddedProduct, isAddFavorite])


    return (
        <div className={styles.card}>
            {(isAddFavorite) ?
                <button onClick={onClickAddFavoriteProduct} className='button button__heart button__heart--active d-flex justify-center align-center'>
                    <HeartActive width={14} height={13} />
                </button> :
                <button onClick={onClickAddFavoriteProduct} className='button button__heart d-flex justify-center align-center'>
            ...
            <div className='d-flex justify-between align-center'>
                ...
                {(isAddedProduct) ?
                    <button className='button button__plus--checked' onClick={onClickAddProduct}>
